...
- Name: 08-authed-shell.spec.js >> Authed shell >> Navbar shows username + role + logout button
- Location: tests\e2e\08-authed-shell.spec.js:18:3
...
Locator: locator('nav').getByText('e2e_user')
Expected: visible
Timeout: 6000ms
...
Call log:
  ...
  - waiting for locator('nav').getByText('e2e_user')
