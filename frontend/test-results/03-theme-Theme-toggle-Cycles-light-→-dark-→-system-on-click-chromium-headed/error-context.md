...
- Name: 03-theme.spec.js >> Theme toggle >> Cycles light → dark → system on click
- Location: tests\e2e\03-theme.spec.js:12:3
...
Locator: locator('nav button[aria-label^=\'Theme:\']')
Expected: visible
Error: strict mode violation: locator('nav button[aria-label^=\'Theme:\']') resolved to 2 elements:
